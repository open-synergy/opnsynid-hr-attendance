...
class ResCompany(models.Model):
    ...
    leave_request_confirm_grp_ids = fields.Many2many(
        ...
        relation="rel_company_2_leave_request_confirm_group",
        column1="company_id",
        column2="group_id",
    )
    leave_request_cancel_grp_ids = fields.Many2many(
        ...
        comodel_name="res.groups",
        relation="rel_company_2_leave_request_cancel_group",
        column1="company_id",
        column2="group_id",
    )
    leave_request_restart_grp_ids = fields.Many2many(
        ...
        comodel_name="res.groups",
        relation="rel_company_2_leave_request_restart_group",
        column1="company_id",
        column2="group_id",
    )
    leave_request_restart_val_grp_ids = fields.Many2many(
        ...
        comodel_name="res.groups",
        relation="rel_company_2_leave_request_restart_val_group",
        column1="company_id",
        column2="group_id",
    )
    leave_allocation_confirm_grp_ids = fields.Many2many(
        ...
        comodel_name="res.groups",
        relation="rel_company_2_leave_allocation_confirm_group",
        column1="company_id",
        column2="group_id",
    )
    leave_allocation_cancel_grp_ids = fields.Many2many(
        ...
        comodel_name="res.groups",
        relation="rel_company_2_leave_allocation_cancel_group",
        column1="company_id",
        column2="group_id",
    )
    leave_allocation_restart_grp_ids = fields.Many2many(
        ...
        comodel_name="res.groups",
        relation="rel_company_2_leave_allocation_restart_group",
        column1="company_id",
        column2="group_id",
    )
    leave_allocation_restart_val_grp_ids = fields.Many2many(
        ...
        comodel_name="res.groups",
        relation="rel_company_2_leave_allocation_restart_val_group",
        column1="company_id",
        column2="group_id",
    )
